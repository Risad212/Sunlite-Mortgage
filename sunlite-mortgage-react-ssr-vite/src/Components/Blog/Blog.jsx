          ...
          <Col lg="9">
            <div className="BlogWidget">
              ...
              <ul className="d-flex lab-ul">
                <li className="me-3">
                  <i className="fa-solid fa-user pe-2"></i>Sunlite Mortgage
                </li>
                <li>
                  <i className="fa-solid fa-calendar-days pe-2"></i>Oct 07, 2022
                </li>
              </ul>
              {/*--- Widget category--- */}
              <ul className="wt-cat">
