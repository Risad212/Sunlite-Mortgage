            ...
            {page == 'home' && (
                <div className="banner">
                    ...
                    <div className="bannerDes">
                        <h1 className="banner-title">Providing Customized Mortgage Solutions<br />To Canadians Since 2003</h1>
            ...
            {page == 'refinance' && (
                <div className="position-relative">
                    ...
                    <div className="refTitle">
                        ...
                        <div><img alt="Mortgage Brokers Toronto" height="2" src="//dvm0q8ak413bh.cloudfront.net/data/org/24607/media/img/source/edit/2714851_edit.png" width="77" className="line-img" /></div>
